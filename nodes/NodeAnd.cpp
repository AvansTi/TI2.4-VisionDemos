...
void NodeAnd::compute(const NodeList& nodes)
{
    ...
    if (t1 == PinType::Image3)
    {
        ...
        if (t2 == PinType::Image3)
        {
            ...
            cv::bitwise_and(img1, img2, image.mat);
        ...
        else if (t2 == PinType::Image1)
        {
            ...
            cv::bitwise_and(img1, combined, image.mat);
            outputPins[0].type = PinType::Image3;
        }
    ...
    else if (t1 == PinType::Image1)
    {
        ...
        if (t2 == PinType::Image3)
        {
            ...
            cv::bitwise_and(img1_3component, img2, image.mat);
            outputPins[0].type = PinType::Image3;
        }
        else if (t2 == PinType::Image1)
        {
...
cv::Mat NodeAnd::getPinImage1(int pinId)
{
